...
class UserdetailsControllerTest < ActionController::TestCase
  ...
  test "should create userdetail" do
    assert_difference('Userdetail.count') do
      post :create, userdetail: { nick: @userdetail.nick, notifications_allowed: @userdetail.notifications_allowed }
    end
  ...
  test "should update userdetail" do
    patch :update, id: @userdetail, userdetail: { nick: @userdetail.nick, notifications_allowed: @userdetail.notifications_allowed }
    assert_redirected_to userdetail_path(assigns(:userdetail))
  end
